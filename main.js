...
// ========== GROUP ADMINS (VU ULTIMATE Style) ==========
...
// ========== EXTRACT MESSAGE BODY (VU ULTIMATE Style) ==========
...
// ========== EXTRACT BUTTON ID (VU ULTIMATE Style) ==========
...
*© Powered by ${OWNER_NAME}*`;
    ...
    if (connection === 'close') {
        ...
        redxLog(`VU ULTIMATE Pair error: ${err.message}`, 'error');
